...
const html = fs.readFileSync(path.join(__dirname, '..', 'data', 'ServerCommandProxy.html'), 'utf8');
...
fs.writeFileSync(path.join(__dirname, '..', 'data', 'papercut-api.json'), JSON.stringify(methods));

const fn = path.join(__dirname, '..', 'data', 'docs.js');
